...
<div class="panel panel-default">
  ...
  {!! Form::open(array('action' => 'EventsController@postEdit', 'class'=>'','id'=>'fileupload','role'=>"form")) !!}
    ...
    <hr>
        ...
        <div id="step1_panel" class="panel-body">
          <!-- The table listing the files available for upload/download -->
              <table id="displayImagesTable" role="presentation" class="table table-striped"><tbody class="files">
                <tr>
                @if(isset($events['image_srcs']))
                  <div class="col-xs-6 col-md-3 template-upload">
                    <a href="#" class="thumbnail">
                      <img src="/assets/images/events/perm/{!!$events['image_srcs']!!}" alt="...">
                    </a>
                  </div>
                @endif
              </tr>
      ...
      <div id="imageDiv" class="hide">
        @if(isset($events['image_srcs']))
          <input class="images" name="files[0][path]" type="hidden" value="{!!$events['image_srcs']!!}"/>
        @endif
      </div>
